  ...
  React.useEffect(() => {
    const fetchFilterOptions = async () => {
      try {
        ...
        if (data.priceRange) {
          // Check if we have a country-specific price range
          ...
          if (countrySpecificRange) {
            ...
            // Initialize price filters if not already set
            if (!filters.priceMin && !filters.priceMax) {
              setFilters(prev => ({
                ...prev,
                priceMin: countrySpecificRange.min,
                priceMax: countrySpecificRange.max
              }));
        ...
        // Map data from API to our format
        setFilterOptions({
